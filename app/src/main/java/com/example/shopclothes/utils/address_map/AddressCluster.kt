package com.example.shopclothes.utils.address_map
...
class AddressCluster(context: Context) : FrameLayout(context) {

    init {
        inflate(context, R.layout.address_cluster, this)
        layoutParams = LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT)
    }

    fun setData(placemarkTypes: List<Any>) {
        Log.d("MyTag", "Set data")
        placemarkTypes.forEach { item ->
